...
public class DiskQueueUtils {
    ...
    public File createRequestObjJsonFile(ComponentSourceDTO csDTO, String basePath) throws Exception{
    	String tmpFileDir= basePath + L10N_TMP_GRM_PATH;
        return createJsonFile(tmpFileDir, csDTO, 0);
    }
