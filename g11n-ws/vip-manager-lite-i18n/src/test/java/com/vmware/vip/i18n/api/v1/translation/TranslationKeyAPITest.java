...
public class TranslationKeyAPITest {
    ...
    @Test
    public void testGetStringTranslationContainComponent() throws Exception {
        RequestUtil.sendRequest(webApplicationContext, ConstantsForTest.GET,ConstantsForTest.StringTranslationContainComponentAPIURI);
    }

    @Test
    public void testGetStringTranslationExclusiveComponent() throws Exception {
        RequestUtil
                .sendRequest(webApplicationContext,ConstantsForTest.GET, ConstantsForTest.StringTranslationExclusiveComponentAPIURI);
    }
