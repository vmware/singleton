...
public class TranslationComponentAPITest {
    ...
    public void testSingleComponent() throws Exception {
        RequestUtil.sendRequest(webApplicationContext, ConstantsForTest.GET,ConstantsForTest.SingleComponentTranslationAPIURI_REST);
    }

    @Test
    public void testMultiComponents() throws Exception {
        RequestUtil.sendRequest(webApplicationContext,ConstantsForTest.GET, ConstantsForTest.MultipleComponentsTranslationAPIURI_REST);
    }
