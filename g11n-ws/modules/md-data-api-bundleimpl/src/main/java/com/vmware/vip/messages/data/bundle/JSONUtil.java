...
public class JSONUtil {
    ...
    */
   private static String getMapOrderJsonStr(Map<String, Object> jsonMap)
    ...
    */
   private static void writeSingleComponentDTOToJSONFile(String jsonFileName,
      ...
      try {
         ...
         writer.write(getMapOrderJsonStr(json));
      } catch (IOException e) {
   ...
   public static void writeJSONObjectToJSONFile(String jsonFileName, String component,
      ...
      writeSingleComponentDTOToJSONFile(jsonFileName, dto);
   }
