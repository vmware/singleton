...
import { RoundingMode, CurrenciesDataType, NumberFormatTypes } from '../intl/intl.util';
...
class Formatter {
    ...
    resetCurrencyFormatsInfo(formatsInfo: any, data: I18n.DataForCurrency, currencyCode: string, min?: number, max?: number) {
...
export class FormatterFactory {
    ...
    currencies( data: I18n.DataForCurrency, locale: string ) {
    ...
    percent( data: I18n.DataForNumber, locale: string ) {
    ...
    decimal( data: I18n.DataForNumber, locale: string ) {
    ...
    roundNumberForPlural( data: I18n.DataForNumber, locale: string  ) {
