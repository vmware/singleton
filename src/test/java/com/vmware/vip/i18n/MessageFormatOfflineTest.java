...
public class MessageFormatOfflineTest extends BaseTestClass {
    ...
    public void testFormatMessageWithSimpleArg(){
       ...
       Locale frLocale = new Locale("fr", "");
        ...
        Assert.assertEquals("At "+ DateFormat.getTimeInstance(DateFormat.SHORT, Locale.ENGLISH).format(date) +" on " + DateFormat.getDateInstance(DateFormat.LONG, Locale.ENGLISH).format(date) + ", there was a disturbance in the Force on planet 7.",
