...
public class APIV2 {
	...
	public static final String COMPONENTS_TRANSLATION_GET = API_TRANSLATOIN + "/products/{" + APIParamName.PRODUCT_NAME+"}/versions/{" + APIParamName.VERSION2 + "}/multlocales/{" + APIParamName.LOCALES + "}/multcomponents/{"+ APIParamName.COMPONENTS + "}";
