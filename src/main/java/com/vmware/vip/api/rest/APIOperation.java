...
public class APIOperation {
    ...
    public final static String PRODUCT_VERSIONINFO_VALUE            = "Get the version info";
    public final static String PRODUCT_VERSIONINFO_NOTES            = "Get the version info by the specific version.";
