...
public class APIV1 {
    ...
    public static final String SUPPORTED_LOCALES   = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/version/{" + APIParamName.VERSION + "}/supportedLocales";
    public static final String COMPONENTS          = API.L10N_API_ROOT + V + "/bundles/components";
    public static final String COMPONENTS2         = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/components/{" + APIParamName.COMPONENTS + "}";
    public static final String COMPONENT           = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/component/{" + APIParamName.COMPONENT + "}";
    public static final String KEY2_GET            = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/component/{" + APIParamName.COMPONENT + "}/key/{" + APIParamName.KEY2
            + "}";
    public static final String PRODUCT_KEY2        = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/key/{" + APIParamName.KEY2 + "}";
    public static final String KEY2_POST           = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/component/{" + APIParamName.COMPONENT + "}/key/{" + APIParamName.KEY2
            + "}";
    public static final String SOURCES_GET         = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/component/{" + APIParamName.COMPONENT + "}/sources";
    public static final String SOURCES_POST        = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/component/{" + APIParamName.COMPONENT + "}/sources";
    public static final String PRODUCT_VERSION     = API.I18N_API_ROOT + V + "/translation/product/{"
            + APIParamName.PRODUCT_NAME + "}/version/{" + APIParamName.VERSION2 + "}";
