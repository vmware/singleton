...
public class NumberFormatting implements Formatting {
	 ...
	 * @param locale The locale for which the number format is desired.
	...
	public String formatNumber(Object value, Integer fractionSize, Locale locale){
	    return new NumberFormatService().format(value, fractionSize, locale, com.vmware.vipclient.i18n.l2.text.NumberFormat.NUMBERSTYLE);
	}
	 ...
	 * @param value The number to be formatted.
	 * @param fractionSize User self defined fraction size.
	 * @param language The language for which the number format is desired.
	 * @param region The region for which the number format is desired.
	 * @return The formatted number string.
	 */
	public String formatNumber(Object value, Integer fractionSize, String language, String region){
	    return new NumberFormatService().format(value, fractionSize, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.NUMBERSTYLE);
	}

	
	public String formatNumber(Object value,  String language, String region){
	    return new NumberFormatService().format(value, null, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.NUMBERSTYLE);
	}
	 ...
	 * 
	 * @param value The number to be formatted.
	 * @param locale The locale for which the percent format is desired.
	...
	public String formatPercent(Object value, Integer fractionSize, Locale locale){
	    return new NumberFormatService().format(value, fractionSize, locale, com.vmware.vipclient.i18n.l2.text.NumberFormat.PERCENTSTYLE);
	}
	...
	public String formatPercent(Object value, Integer fractionSize, String language, String region){
	    return new NumberFormatService().format(value, fractionSize, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.PERCENTSTYLE);
	}
	
	
	
	public String formatPercent(Object value, String language, String region){
	    return new NumberFormatService().format(value, null, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.PERCENTSTYLE);
	}
	 ...
	 * @param locale The locale for which the currency format is desired.
	...
	public String formatCurrency(Object amount, String currencyCode, Locale locale){
	     return new NumberFormatService().format(amount, currencyCode, null, locale, com.vmware.vipclient.i18n.l2.text.NumberFormat.CURRENCYSTYLE);
	}
	...
	public String formatCurrency(Object amount, String currencyCode, String language, String region){
	     return new NumberFormatService().format(amount, currencyCode, null, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.CURRENCYSTYLE);
	}
	
	
	public String formatCurrency(Object amount, String language, String region){
	     return new NumberFormatService().format(amount,  ConstantsKeys.USD, null, language, region, com.vmware.vipclient.i18n.l2.text.NumberFormat.CURRENCYSTYLE);
	}
}
