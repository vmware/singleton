...
public class PluralRules implements Serializable {
	...
	protected static final List<String> KEYWORD_LIST = Arrays.asList( KEYWORD_ZERO, KEYWORD_ONE, KEYWORD_TWO, KEYWORD_FEW, KEYWORD_MANY, KEYWORD_OTHER); 
	 ...
	 * returns null.
	 * @param description the rule rule.
	...
	public static class FixedDecimal extends Number implements Comparable<FixedDecimal>, IFixedDecimal {
		 ...
		 * @param v number of digits to the right of the decimal place. e.g
		 *            1.00 = 2 25. = 0
		 * @param f Corresponds to f in the plural rules grammar. The digits
...
//		}
	...
	public static PluralRules forLocale(Locale locale, PluralType type) {
		...
		try{
			JSONObject pluralPattern = new PatternService().getPatternsByCategory(locale.toLanguageTag(), PatternCategory.PLURALS.toString());
