...
public class LocalSrcMessagesPropsOpt implements Opt, MessageOpt {

	private Logger logger = LoggerFactory.getLogger(LocalSrcMessagesPropsOpt.class.getName());

	private static final String PROPERTIES_SUFFIX = ".properties";
    private MessagesDTO dto;

    public LocalSrcMessagesPropsOpt(MessagesDTO dto) {
        this.dto = dto;
    }
