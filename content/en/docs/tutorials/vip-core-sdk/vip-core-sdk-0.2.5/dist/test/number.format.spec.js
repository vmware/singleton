 ...
 */
const number_formatter_1 = require("../src/formatters/number.formatter");
const locale_de_1 = require("./locale.de");
const locale_en_1 = require("../src/data/locale_en");
describe('number formatter', () => {
    const dataForEn = locale_en_1.default.categories.numbers;
    const dataForDe = locale_de_1.default.categories.numbers;
    const formatterFactory = new number_formatter_1.FormatterFactory();
