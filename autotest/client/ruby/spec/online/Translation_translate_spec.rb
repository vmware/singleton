...
describe "tmplete 1 test" do
    ...
    context "getString_f translation" do
        ...
        it "Get a string's translation and component in bundle and locale is de" do
        ...
        it "Get a string's translation and source is equal debug 10" do
            Sgtn.locale = "de"
            expect(Sgtn.translate('about.testw', "about", name: "haha", place: "single")).to eq("haha, welcome de single!")
        end
