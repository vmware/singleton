...
describe "Translation test" do
    before :each do
        ...
        Sgtn.load_config("./config/sgtnclient.yml", "onlyofflinemode")
    ...
    context "getString_f translation" do
        ...
        it "Get the string's translation and argument is more than 4" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome", {"name": "xiaoming", "place": "singleton"},"de","de")).to eq("xiaoming, welcome login singleton de offline!")
        end
        ...
        it "Get the string's translation and placehoder is equal argument" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome", {"name": "xiaoming", "place": "singleton"},"de")).to eq("xiaoming, welcome login singleton de offline!")
        end
        ...
        it "Get the string's translation and placehoder source not equal latest" do
            expect(SgtnClient::Translation.getString_f("contact", "contact.welcome2", {"name": "xiaoming", "place": "singleton"},"de")).to eq("xiaoming, welcome contact source login singleton!")
        end
        ...
        it "Get the string's translation and key not in source and in bunlde locale is en" do
            expect(SgtnClient::Translation.getString_f("about", "about.change", {"name": "xiaoming", "place": "singleton"},"en")).to eq("%xiaoming, welcome chanege %singleton!")
        end

        it "Get the string's translation and key not in source and in bunlde and locale is de____new dleng bug" do
            expect(SgtnClient::Translation.getString_f("about", "about.change", {"name": "xiaoming", "place": "singleton"},"de")).to eq("%xiaoming, welcome chanege de %singleton!")
        end
        ...
        it "Get the string's translation and placehoder is more than argument" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome", {"name": "xiaoming", "place": "singleton", "add": "singleton23"},"de")).to eq("xiaoming, welcome login singleton de offline!")
        end

        it "Get the string's translation and placehoder is less than argument" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome", {"place": "singleton" },"de")).to eq("{name}, welcome login singleton de offline!")
        end

        it "Get the string's translation and placehoder is empty" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome",{} ,"de")).to eq("{name}, welcome login {place} de offline!")
        end

        it "Get the string's translation and placehoder is nil" do
            expect(SgtnClient::Translation.getString_f("about", "about.welcome",nil ,"de")).to eq("{name}, welcome login {place} de offline!")
        end
