...
describe "tmplete 1 test" do
    ...
    context "getString_f translation" do
        ...
        # it "Get a string's translation and source is equal debug" do
        #     #expect(Sgtn.translate('about.testw', "about", 'en', name: "haha", place: "single")).to eq("haha, welcome single!")
        #     #expect(Sgtn.translate('about.testw', "about", 'en')).to eq("haha, welcome single!")
        #     puts Sgtn.translate('about.testw', "about", 'en', name: "haha", place: "single")
        #     #expect(Sgtn.translate('about.testw', "about", 'en', name: "haha", place: "single")).to eq("haha, welcome single!")
        #     #expect(Sgtn.translate('about.testw', "about", 'en')).to eq("haha, welcome single!")
        # end

        it "Get a string's translation and source is not equal debug1" do
        ...
        it "Get a string's translation and source is not equal and locale is de" do
            #expect(Sgtn.translate('about.notequal2', "about", 'de')).to eq("haha, welcome login not equal source single!")
