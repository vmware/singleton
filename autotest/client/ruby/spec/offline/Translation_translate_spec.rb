...
describe "tmplete 1 test" do
    ...
    context "getString_f translation" do
        ...
        it "Get a string's translation and component in bundle and locale is de____new dleng bug" do
            expect(Sgtn.translate('contact.welcome3', "contact", 'de')).to eq("%{name}, welcome contact login de %{place}!")
        end
        ...
        it "Get a string's translation and source is equal" do
            expect(Sgtn.translate('about.testw', "about", 'zh-cn', name: "haha", place: "single")).to eq("haha, welcome zh-Hans single!")
        end

        it "Get a string's translation and source is equal" do
            expect(Sgtn.translate('about.testw', "about", 'DE-DE', name: "haha", place: "single")).to eq("haha, welcome de single!")
        end

        it "Get a string's translation and source is equal" do
            expect(Sgtn.translate('about.testw', "about", 'en-US', name: "haha", place: "single")).to eq("haha, welcome single!")
        end
        ...
        it "Get a string's translation and source is equal and locale is de" do
            expect(Sgtn.translate('about.testw', "about", 'de', name: "haha", place: "single")).to eq("haha, welcome de single!")
        end
        ...
        it "Get a string's translation and source is fr-CA" do
            expect(Sgtn.translate('about.testw', "about", 'fr-CA', name: "haha", place: "single")).to eq("haha, welcome single! fr-CA")
        end
        ...
        # it "Get a string's translation and placehorder is less than argument____new discuss 123" do
        #     expect(Sgtn.translate('about.testw', "about", 'zh-Hans', name: "haha")).to eq("haha, welcome zh-Hans single!")
        # end

        it "Get a string's translation and placehorder is : de" do
            expect(Sgtn.translate('about.testw', "about", :de, name: "haha", place: nil)).to eq("haha, welcome de !")
        end
