...
describe "Translation test" do
    ...
    context "getString_f translation" do
        ...
        it "Get the string's translation and placehoder is component not in source and locale is en" do
            expect(SgtnClient::Translation.getString_f("contact", "contact.welcome2", {"name": "xiaoming", "place": "singleton"},"en")).to eq("xiaoming, welcome contact source login singleton!")
        end
