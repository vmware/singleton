...
describe "Translation test" do
    ...
    context "Get string's translation" do
        ...
        it "Get a string's translation and component exist in server but not exist in source" do
            expect(SgtnClient::Translation.getString("contact", "contact.title", "en")).to eq("Contact")
        end

        it "Get a string's translation and component exist in server but not exist in source and locale is de____new dleng bug" do
            expect(SgtnClient::Translation.getString("contact", "contact.title", "de")).to eq("Kontakt")
        end
        ...
        it "Get a string's translation and key not exist in server but exist in source and lcoale is de" do
        ...
        # it "Get a string's translation and key exist in server but not exist in source and locale is de____new dleng bug" do
        #     expect(SgtnClient::Translation.getString("about", "about.title", "de")).to eq("About de")
        # end
        ...
        it "Get a string's translation and en is not enqual source and locale is de" do
            expect(SgtnClient::Translation.getString("about", "about.description", "de")).to eq("Use this area to provide additional information source")
        end

        it "Get a string's translation and locale is de" do
            expect(SgtnClient::Translation.getString("about", "about.message", "de_ca")).to eq("test de key offline")
        end
        ...
        it "Get a string's translation and unsupport locale(xxxxx)" do
            expect(SgtnClient::Translation.getString("about", "about.message", "xxxxx")).to eq("Your application description page. offline")
        end

        it "Get a string's translation and locale is nil" do
            expect(SgtnClient::Translation.getString("about", "about.message", nil)).to eq("Your application description page. offline")
        end

        it "Get a string's translation and locale is int" do
            expect(SgtnClient::Translation.getString("about", "about.message", 123)).to eq("Your application description page. offline")
        end
