...
namespace CSharp
{
    ...
    public class GetStringMTTrue
    {
        ...
        public GetStringMTTrue()
        {
            ...
            //from resx file
            SourceArgument = Translation.CreateSource("RESX", "RESX.ARGUMENT", "Add {0} to the object.", "argument verification");// the object.
            //from resx file
        ...
        public void GetMT_nonexistentLanguage_FullParameters()
        {
            ...
            Translation.SetCurrentLocale("da");
            String resultABC1 = Translation.GetString("RESX", TestDataConstant.keyError, null);
            //String resultABC2 = Translation.GetString("RESX", TestDataConstant.keyArg, null);
