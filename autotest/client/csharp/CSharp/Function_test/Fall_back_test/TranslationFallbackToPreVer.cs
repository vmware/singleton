...
namespace CSharp
{
    ...
    public class GetStringFromPreVersion
    {
        ...
        public void GetLocaleMessages_nonexistentComponent()
        {
            ...
            Console.WriteLine("FR transaltion: {0}", resultDAFull);
            Assert.AreEqual(TestDataConstant.valueArg, resultDAFull);
        ...
        public void GetLocaleMessages_ExistingComponent_previousversion()
        {
            ...
            Translation.SetCurrentLocale("ja");
            String resultDAFull = Translation.GetString("about", "about.message");
            Assert.AreEqual("アプリケーションの説明ページ。", resultDAFull);
