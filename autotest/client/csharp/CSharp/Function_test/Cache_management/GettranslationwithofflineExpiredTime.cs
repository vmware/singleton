...
{
    [TestClass]
    public class GetLocaleMessagesfromcachewithofflineExpiredTime
    {
        ...
        public GetLocaleMessagesfromcachewithofflineExpiredTime()
        {
        ...
        public void GetLocaleMessages_ExistingLanguage_Argument_Format_cacheexpiration()
        {
            ...
            String result1 = Translation.Format(Currentlocale1, SourceAbout);
