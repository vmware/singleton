...
namespace CSharp
{
    class sgtn_offline_internal_native
    {
        public static string BASE_RES_NAME = "Resources.Resource";
        public static Assembly assembly = typeof(sgtn_offline_internal_native).Assembly;
    }

    public class Utiloffline_internal_native
    {
        ...
        public static void Init()
        {
            IConfig cfg = I18N.LoadConfig(
                sgtn_offline_internal_native.BASE_RES_NAME, sgtn_offline_internal_native.assembly, "sgtn_offline_internal_native");
