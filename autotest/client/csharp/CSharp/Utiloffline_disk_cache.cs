...
namespace CSharp
{
    class sgtn_offline_disk_cache
    {
        public static string BASE_RES_NAME = "Resources.Resource";
        public static Assembly assembly = typeof(sgtn_offline_disk_cache).Assembly;
    }

    public class Utiloffline_disk_cache
    {
        ...
        public static void Init()
        {
            IConfig cfg = I18N.LoadConfig(
                sgtn_offline_disk_cache.BASE_RES_NAME, sgtn_offline_disk_cache.assembly, "sgtn_offline_disk_cache");
