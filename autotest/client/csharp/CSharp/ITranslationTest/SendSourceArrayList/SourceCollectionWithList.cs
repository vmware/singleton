...
namespace CSharp
{
    ...
    public class SourceCollectTrue
    {
        ...
        public void SourceCollection_MultiString_GetString()
        {
            ...
            srcList.Add(UtilCollectTrue.Source("CollectSourceComponentTrue", "SourceList_collect.00000000-0000-0000-0000-000000000000.templates_Draas-SSLCertificateRenew-completed.text", "<html><body><p>Replacement of SSL Certificates of the Site Recovery Manager.</p></body></html>", "this is a comment."));
            UtilCollectTrue.Translation().SendSource(srcList);
