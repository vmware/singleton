...
namespace CSharp
{
    class sgtn_offline_external
    {
        public static string BASE_RES_NAME = "Resources.Resource";
        public static Assembly assembly = typeof(sgtn_offline_external).Assembly;
    }

    public class Utiloffline_external
    {
        ...
        public static void Init()
        {
            IConfig cfg = I18N.LoadConfig(
                sgtn_offline_external.BASE_RES_NAME, sgtn_offline_external.assembly, "sgtn_offline_external");
