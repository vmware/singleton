...
//	public static final String APIINFO_FILE_PATH = Paths.get(RESOURCE_FOLDER, APIINFO_FILE_NAME).toString();
	...
	public static final String VIP_CONFIG_FILE_NAME = "vipconfig.properties";
	public static final String CONFIG_FILE_PATH = Paths.get(RESOURCE_FOLDER, CONFIG_FILE_NAME).toString();
	public static final String VIP_CONFIG_FILE_PATH = Paths.get(RESOURCE_FOLDER, VIP_CONFIG_FILE_NAME).toString();
	...
	public static final String CONF_KEY_TEST_DATA_SHEET = "test.data.sheets";
	...
	public static final String CONF_KEY_TEST_DATA_COLUMN_PARAM  = "test.data.column.testdata";
	...
	public static final String VIP_CONF_KEY_VIP_SERVER = "vipServer";
	public static final String VIP_CONF_KEY_INIT_CACHE = "initializeCache";
	public static final String VIP_CONF_KEY_PSEUDO = "pseudo";
	public static final String VIP_CONF_KEY_COLLECT_SROUCE = "collectSource";
	public static final String VIP_CONF_KEY_CLEAN_CACHE = "cleanCache";
	public static final String VIP_CONF_KEY_MT = "machineTranslation";
	public static final String VIP_CONF_KEY_I18N_SCOPE = "i18nScope";
	public static final String VIP_CONF_KEY_CACHE_EXPIRED_TIME = "cacheExpiredTime";
	...
	public static final String SOURCE_PSEUDO_PATTERN = "@@%s@@";
