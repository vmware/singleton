...
func TestGetComponentsTranslation(t *testing.T) {
	...
	Convey("component-Service-return: Get data from service", t, func() {

		SkipConvey("2 locales/components, get data from service", func() {
		...
		SkipConvey("1 locale/component, get data from service", func() {
		...
		SkipConvey("all locales if not define specific locale, get data from service", func() {
		...
		Convey("all components if not define specific component, get data from service", func() {
		...
		SkipConvey("all locales/components if not define specific locale/component, get data from service", func() {
		...
		SkipConvey("version fallback: 2 locales/components, get data from service", func() {
		...
		SkipConvey("language fallback: 2 locales/components, get data from service", func() {
		...
		SkipConvey("1 locale/2 components(one is existing, another isn't), get existing component data from service", func() {
	...
	SkipConvey("component-Service-error: invalid requested data", t, func() {
