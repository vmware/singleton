...
func TestGetStringlocalsourceTranslation(t *testing.T) {
	...
	Convey("localbundles-requestlocale: Get request locale's translation from localbundle", t, func() {
		...
		Convey("regester equal ko-ch", func() {
			...
			tran1, _ := translation.GetStringMessage("testsource", "1.0.0", "ja", "DefaultComponent", "messages.welcome")
			...
			//So(tran2, ShouldEqual, "Welcome")
			commsg, _ := translation.GetComponentMessages("testsource", "1.0.0", "ko", "DefaultComponent")
			commsg1, _ := translation.GetComponentMessages("testsource", "1.0.0", "fr", "DefaultComponent")
			fmt.Print("**********************************************************************************1111\n")
			fmt.Print(commsg)
			fmt.Print("\n**********************************************************************************11112\n")
			fmt.Print(commsg1)
		...
		Convey("regester the component only in testsourceed source--- bug2", func() {

			tran1, _ := translation.GetStringMessage("GoClientTest", "1.0.0", "da", "DefaultComponent", "messages.welcome")
		...
		// 	commsg, _ := translation.GetComponentMessages("testsource", "1.0.0", "de", "DefaultComponent")
		// 	fmt.Print("\n###########################################################################\n")
		// 	fmt.Print(commsg)
