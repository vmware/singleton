...
class TestComponent {
    ...
    @ViewChild('withParam') withParam: ElementRef;
    @ViewChild('withParams') withParams: ElementRef;
    @ViewChild('withNoTranslation') withNoTranslation: ElementRef;
...
describe('l10n directive', () => {
     ...
     */
    const config = Object.assign(baseConfig, { language: locale, sourceBundle: en, isPseudo: true });
