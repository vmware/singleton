...
describe SgtnClient do
  describe "Cache" do
    ...
    it "default" do
      ...
      SgtnClient::Source.loadBundles(source_locale)
      config_lang = SgtnClient::Config.configurations[env]["source_locale"]
      ...
      SgtnClient::Config.configurations[env]["source_locale"] = 'zh-Hans'
